...
/**
 * Esta clase define un objeto con una animacion de moneda que se movera en y hasta que desaparezca
 *
...
public class Coin {
    ...
    /**
     * Objeto enemigo del que va a salir el objeto
     */
    private Enemy enemy;

    /**
     * Constructor para Coin
     *
     * @param enemy Objeto enemigo del que va a salir el objeto.
     * @param world Clase donde irá el objeto.
     */
    public Coin(Enemy enemy, GameWorld world) {
        this.enemy = enemy;
        this.world = world;
    ...
    public void draw(SpriteBatch batch, float runtime) {
        frame += runtime;
        batch.begin();
        batch.draw((TextureRegion) AssetLoader.coin.getKeyFrame(frame), rect.x, rect.y, rect.width, rect.height);
        batch.end();
    }
}
